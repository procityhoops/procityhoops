angular.module('appRoutes', ['NewsFeedCtrl']).config(function($routeProvider, $locationProvider) {
	...
	.when('/wolfden-the-many-opinions-on-thibs', {
		templateUrl : 'articles/wolfden-the-many-opinions-on-thibs.html'
	})

	.when('/wolfden-jimmy-butler-injury-how-do-wolves-get-by', {
		templateUrl : 'articles/wolfden-jimmy-butler-injury-how-do-wolves-get-by.html'
	})
	...
	.when('/nba-improvers', {
		templateUrl : 'articles/nba-improvers.html'
	})
	...
	.when('/moving-the-max', {
		templateUrl : 'articles/moving-the-max.html'
	})
	...
	.when('/the-next-big-thing-nikola-jokic', {
		templateUrl : 'articles/the-next-big-thing-nikola-jokic.html'
	})

	.when('/top-nba-duke-players', {
		templateUrl : 'articles/top-nba-duke-players.html'
	})
	...
	.when('/wolfden-wolves-lakers-9-30-17', {
		templateUrl : 'articles/wolfden-wolves-lakers-9-30-17.html'
	})
	...
	.when('/historic-2017-nba-season', {
		templateUrl : 'articles/historic-2017-nba-season.html'
	})
