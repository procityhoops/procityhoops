	...
	generateSitemap: function () {
		var sitemap = sitemapModule.createSitemap ({
			...
			urls: [
				...
				{ url: '/wolfden-wolves-leaders',  changefreq: 'weekly'},
				{ url: '/wolfden-wolves-articles',  changefreq: 'weekly'},
				...
				{ url: '/celtics',  changefreq: 'daily'},
				{ url: '/hawks',  changefreq: 'daily'},
				{ url: '/nets',  changefreq: 'daily'},
				{ url: '/hornets',  changefreq: 'daily'},
				{ url: '/bulls',  changefreq: 'daily'},
				{ url: '/cavaliers',  changefreq: 'daily'},
				{ url: '/pistons',  changefreq: 'daily'},
				{ url: '/pacers',  changefreq: 'daily'},
				{ url: '/heat',  changefreq: 'daily'},
				{ url: '/bucks',  changefreq: 'daily'},
				{ url: '/76ers',  changefreq: 'daily'},
				{ url: '/knicks',  changefreq: 'daily'},
				{ url: '/magic',  changefreq: 'daily'},
				{ url: '/raptors',  changefreq: 'daily'},
				{ url: '/wizards',  changefreq: 'daily'},
				{ url: '/mavericks',  changefreq: 'daily'},
				{ url: '/nuggets',  changefreq: 'daily'},
				{ url: '/warriors',  changefreq: 'daily'},
				{ url: '/rockets',  changefreq: 'daily'},
				{ url: '/clippers',  changefreq: 'daily'},
				{ url: '/grizzlies',  changefreq: 'daily'},
				{ url: '/lakers',  changefreq: 'daily'},
				{ url: '/thunder',  changefreq: 'daily'},
				{ url: '/pelicans',  changefreq: 'daily'},
				{ url: '/timberwolves',  changefreq: 'daily'},
				{ url: '/suns',  changefreq: 'daily'},
				{ url: '/trail%20blazers',  changefreq: 'daily'},
				{ url: '/spurs',  changefreq: 'daily'},
				{ url: '/kings',  changefreq: 'daily'},
				{ url: '/jazz',  changefreq: 'daily'},
